          ...
          <div>
            ...
            <div className="space-y-6 text-gray-600 leading-relaxed">
              ...
              <div className="bg-gradient-to-r from-green-50 to-blue-50 p-4 rounded-xl border-l-4 border-green-500">
                <h4 className="font-bold text-gray-900 mb-2">🤖 Личный кабинет с ИИ уже работает!</h4>
                <p className="text-sm text-gray-600">
                  Революционные возможности: автозаполнение документов, ИИ-оценка повреждений авто, 
                  персональные консультации по ремонту и полный контроль сделки в реальном времени.
                </p>
              </div>
            </div>
